...
Motion::Project::App.setup do |app|
  ...
  # ===========================================================================================
   app.identifier = 'net.fullfive.BouncingDVDLogo'
  ...
  #    see there below.
  # ===========================================================================================
   app.codesign_certificate = 'iPhone Developer: Troy Walker'
  ...
  # ===========================================================================================
   app.provisioning_profile = '~/Brynnon_Provision_Profile.mobileprovision'
